...
Brainfuck programs are one of eight different characters, each one performing
...
more abilities than the language we're programming in. For example, while it's
